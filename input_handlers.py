...
class SelectIndexHandler(AskUserEventHandler):
    # For asking the user for an index on the map.
    def __init__(self, engine: Engine):
...
class MainGameEventHandler(EventHandler):
    # receiving key press events to call an Action
    def ev_keydown(self, event: tcod.event.KeyDown) -> Optional[ActionOrHandler]:
        # action - variable containing subclass of Action if no valid key was pressed it remain as None
        ...
        # temporarily assigning esc key to exit the game
